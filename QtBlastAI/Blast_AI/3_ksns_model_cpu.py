...
def main():
  ...
  # print(reg_sqr)
  inp_train = inp_train.cpu()
  lab_ks_train = lab_ks_train.cpu()
  # lab_ns_train = lab_ns_train.cpu()

  inp_valid = inp_valid.cpu()
  lab_ks_valid = lab_ks_valid.cpu()
  # lab_ns_valid = lab_ns_valid.cpu()

  inp_test = inp_test.cpu()
  lab_ks_test = lab_ks_test.cpu()
  # lab_ns_test = lab_ns_test.cpu()
  ...
  for step in range(step_size):
    ...
    # err = np.nan
    # if K[K2].size()[0] > 0 and step % 10 == 0:
    #   err = loss(D,torch.zeros(D.size()).cpu())
